...
///////////////////////////////////////////////////////////////////////////////
#define GET_LOG(LOGNAME) \
    auto logger = spdlog::get(LOGNAME);
#define LOG_WARN(LOGNAME, FORMAT, ARGS...) \
    {\
        GET_LOG(LOGNAME);\
        if(logger) {logger->warn(FORMAT, ARGS);}\
        else {std::cerr<<"the logger [" LOGNAME "] is not found" << std::endl;}\
    }
#define LOG_ERROR(LOGNAME, FORMAT, ARGS...) \
    {\
        GET_LOG(LOGNAME);\
        if(logger) {logger->error(FORMAT, ARGS);}\
        else {std::cerr<<"the logger [" LOGNAME "] is not found" << std::endl;}\
    }
#define LOG_INFO(LOGNAME, FORMAT, ARGS...) \
    {\
        GET_LOG(LOGNAME);\
        if(logger) {logger->info(FORMAT, ARGS);}\
        else {std::cerr<<"the logger [" LOGNAME "] is not found" << std::endl;}\
    }
///////////////////////////////////////////////////////////////////////////////
